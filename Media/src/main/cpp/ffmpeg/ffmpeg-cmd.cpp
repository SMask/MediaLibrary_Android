...
Java_com_mask_media_jni_FFmpegJni_run(JNIEnv *env, jclass type, jint cmdLen, jobjectArray cmd) {
    //set java vm
    JavaVM *jvm = NULL;
    env->GetJavaVM(&jvm);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_mask_media_jni_FFmpegJni_getProgress(JNIEnv *env, jclass clazz) {
    return get_progress();
}

extern "C"
JNIEXPORT jdouble JNICALL
Java_com_mask_media_jni_FFmpegJni_getSpeed(JNIEnv *env, jclass clazz) {
    return get_speed();
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_mask_media_jni_FFmpegJni_getMediaInfo(JNIEnv *env, jclass clazz, jstring _path) {
